        ...
        fadeEffect={{ crossFade: true }}
            ...
            pagination={{
                ...
                renderBullet: (index, className) => {
                    ...
                    return `<spanclassName="${className} flex" style="background-color: ${colors[index % colors.length]}"></span>`;
                },
            }}
            autoplay={{
                delay: 9000,
                    ...
                    <div className='diller flex flex-col  md:flex-row gap-6 md:gap-8 '>
                        {visibleLanguages.map((lang, index) => (
                            ...
                            >
                                ...
                                <h1 className='dark-text-shadow text-sm md:text-xl font-bold text-gray-100   mt-0 md:mt-2   '>{lang.name}</h1>
                            </div>
                        ))}
                    </div>
                </div>
            </SwiperSlide>
            <SwiperSlide className='relative p-0 xl:ps-16 pt-8  md:pt-28'>
    {/* Arka Plan Görseli */}
        ...
        <div className='flex flex-row flex-wrap justify-center gap-3 pt-8 md:pt-0'>
            {informatics.map((inf, index) => (
                <div key={index} className='relative mb-8 d:mb-0 flex flex-col  items-center lg:w-36 '>
                    ...
                    <h1 className='text-center text-sm md:text-lg font-semibold text-gray-100  dark-text-shadow z-50'>
                        {inf.name}
                    </h1>
                </div>
            ))}
