...
const Accreditation = () => {
  ...
  return (
    <div className="py-16 px-4 md:px-0">
      ...
      <div className="container mx-auto  static xl:relative">
        ...
        <div className="static xl:relative  rounded-3xl shadow-2xl  w-full xl:w-2/3 bg-[url('/images/home-page/accreditation/303.png')] bg-cover bg-top bg-no-repeat border-8">
  
        <div className='p-8  xl:w-[40rem] '>
          
            <h2 className='text-2xl md:text-3xl font-extrabold text-gray-800 leading-tight mb-3 z-50'> 
          ...
          <div className='flex flex-col md:flex-row justify-center items-center gap-5 mt-3'>
            <div className='relative w-32 h-32 md:w-96 md:h-44'>
              <Image src="/images/iso1.png" fill className='object-contain' alt='x'/>
            </div>
            <div>
              <h3 className='text-lg  md:text-2xl font-bold text-gray-700 '>İSO 9001</h3>
          ...
          <Image src="/images/iso1.png" fill className='object-contain'alt='x' />
            ...
            <div>
              <h3 className='text-lg  md:text-2xl font-bold text-gray-700'>İSO 9002</h3>
        ...
        {/* Video ve Kontroller */}
        <div className="relative mt-6 xl:mt-8 mx-auto xl:mx-0 xl:absolute xl:top-10 xl:left-[40rem] corner-shadow xl:w-[35rem] xl:w-[40rem] h-auto rounded-2xl z-50 border-4 border-white ">
  <video
    ref={videoRef}
  ...
  {/* Siyah Overlay */}
  <div
    className={`absolute inset-0 bg-black rounded-2xl opacity-70 transition-opacity duration-300 ${
  ...
  >
    {isPlaying ? (
      <Image src="/images/stop-icon.png" width={100} height={100} alt='x'/>
    ) : (
      <Image src="/images/play-icon.png" width={100} height={100} alt='x'/>
    )}
  </div>
