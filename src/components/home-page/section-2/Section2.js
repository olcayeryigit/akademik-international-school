...
const Section2 = () => {
  ...
  return (
    ...
    <div className="container mx-auto px-4 py-16 md:px-0 ">
      ...
      <div className="flex flex-col md:flex-row justify-center gap-10">
        {data.map((item) => (
          <div
            ...
            className={`w-full md:w-96 border-2 rounded-lg transition-all duration-300 cursor-pointer p-4 ${
              selectedId === item.id
                ? "bg-gray-200 bg-opacity-30 border-gray-600 shadow-lg"
                : "bg-gray-50 bg-opacity-30  border-gray-300"
            } hover:shadow-lg hover:border-gray-600`}
          >
            <div className="flex flex-col md:flex-col items-center gap-0 rounded-lg">
      ...
      <div className="hidden md:flex flex-col md:flex-row items-start gap-12  p-4 rounded-lg ">
        {/* Metin Bölümü */}
        <div className="w-full md:w-2/3 space-y-4 transition-opacity duration-500 ease-in-out bg-white p-5 bg-opacity-60 border border-gray-300 rounded-lg ">
        ...
        <div className="w-full md:w-1/3 flex items-center justify-center">
          <div className="relative w-full h-[600px] md:h-[450px] flex items-center justify-center overflow-hidden rounded-lg shadow-md transform transition duration-500 ease-in-out border border-2 border-gray-300">
            <Image
