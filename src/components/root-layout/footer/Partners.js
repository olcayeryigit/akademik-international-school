...
const Partners = () => {
  ...
  const partnersData = {
    top: [
      { src: "/images/logos/partners/top/1.webp", alt: "Partner 1" },
      { src: "/images/logos/partners/top/2.webp", alt: "Partner 2" },
      { src: "/images/logos/partners/top/3.webp", alt: "Partner 3" }
    ],
    bottom: [
      { src: "/images/logos/partners/bottom/1.svg", alt: "Partner 4" },
      { src: "/images/logos/partners/bottom/6.svg", alt: "Partner 5" },
      { src: "/images/logos/partners/bottom/2.webp", alt: "Partner 6" },
      { src: "/images/logos/partners/bottom/3.webp", alt: "Partner 7" },
      { src: "/images/logos/partners/bottom/4.webp", alt: "Partner 8" },
      { src: "/images/logos/partners/bottom/5.svg", alt: "Partner 9" }
    ]
  };
