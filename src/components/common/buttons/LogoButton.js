      ...
      {theme === "dark" && (
        <>
          <div className={`logo1 relative ${logoSize}`}>
            <Image src="/images/logos/ak-1.png" alt="Logo 1" fill className="contain" />
          </div>
          <div className={`logo2 relative ${logoSize}`}>
            <Image src="/images/logos/ak-2.png" alt="Logo 2" fill className="contain" />
          </div>
        </>
      )}
      {theme === "clear" && (
        <>
          <div className={`logo1 relative  ${logoSize} `}>
            <Image src="/images/logos/ak-2.png" alt="Logo 2" fill className="object-contain" />
          </div>
          <div className={`logo2 relative ${logoSize}  `}>
            <Image src="/images/logos/ak-1.png" alt="Logo 1" fill className="object-contain" />
          </div>
        </>
      )}
    </div></div>
